...
CREATE TABLE inventory_fact_1998 (product_id INTEGER NOT NULL, time_id INTEGER, warehouse_id INTEGER, store_id INTEGER, units_ordered INTEGER, units_shipped INTEGER, warehouse_sales DECIMAL(10,4), warehouse_cost DECIMAL(10,4), supply_time SMALLINT, store_invoice DECIMAL(10,4));
...
CREATE TABLE expense_fact (store_id INTEGER NOT NULL, account_id INTEGER NOT NULL, exp_date TIMESTAMP NOT NULL, time_id INTEGER NOT NULL, category_id VARCHAR(30) NOT NULL, currency_id INTEGER NOT NULL, amount DECIMAL(10,4) NOT NULL);

CREATE TABLE store_ragged (store_id INTEGER NOT NULL, store_type VARCHAR(30), region_id INTEGER, store_name VARCHAR(30), store_number INTEGER, store_street_address VARCHAR(30), store_city VARCHAR(30), store_state VARCHAR(30), store_postal_code VARCHAR(30), store_country VARCHAR(30), store_manager VARCHAR(30), store_phone VARCHAR(30), store_fax VARCHAR(30), first_opened_date TIMESTAMP, last_remodel_date TIMESTAMP, store_sqft INTEGER, grocery_sqft INTEGER, frozen_sqft INTEGER, meat_sqft INTEGER, coffee_bar SMALLINT, video_store SMALLINT, salad_bar SMALLINT, prepared_food SMALLINT, florist SMALLINT);
...
CREATE TABLE salary (pay_date TIMESTAMP NOT NULL, employee_id INTEGER NOT NULL, department_id INTEGER NOT NULL, currency_id INTEGER NOT NULL, salary_paid DECIMAL(10,4) NOT NULL, overtime_paid DECIMAL(10,4) NOT NULL, vacation_accrued REAL NOT NULL, vacation_used REAL NOT NULL);

CREATE TABLE warehouse_class (warehouse_class_id INTEGER NOT NULL, description VARCHAR(30));

CREATE TABLE inventory_fact_1997 (product_id INTEGER NOT NULL, time_id INTEGER, warehouse_id INTEGER, store_id INTEGER, units_ordered INTEGER, units_shipped INTEGER, warehouse_sales DECIMAL(10,4), warehouse_cost DECIMAL(10,4), supply_time SMALLINT, store_invoice DECIMAL(10,4));
...
CREATE TABLE product_class (product_class_id INTEGER NOT NULL, product_subcategory VARCHAR(30), product_category VARCHAR(30), product_department VARCHAR(30), product_family VARCHAR(30));
...
CREATE TABLE position (position_id INTEGER NOT NULL, position_title VARCHAR(30) NOT NULL, pay_type VARCHAR(30) NOT NULL, min_scale DECIMAL(10,4) NOT NULL, max_scale DECIMAL(10,4) NOT NULL, management_role VARCHAR(30) NOT NULL);

CREATE TABLE time_by_day (time_id INTEGER NOT NULL, the_date TIMESTAMP, the_day VARCHAR(30), the_month VARCHAR(30), the_year SMALLINT, day_of_month SMALLINT, week_of_year INTEGER, month_of_year SMALLINT, quarter VARCHAR(30), fiscal_period VARCHAR(30));
...
CREATE TABLE store (store_id INTEGER NOT NULL, store_type VARCHAR(30), region_id INTEGER, store_name VARCHAR(30), store_number INTEGER, store_street_address VARCHAR(30), store_city VARCHAR(30), store_state VARCHAR(30), store_postal_code VARCHAR(30), store_country VARCHAR(30), store_manager VARCHAR(30), store_phone VARCHAR(30), store_fax VARCHAR(30), first_opened_date TIMESTAMP, last_remodel_date TIMESTAMP, store_sqft INTEGER, grocery_sqft INTEGER, frozen_sqft INTEGER, meat_sqft INTEGER, coffee_bar SMALLINT, video_store SMALLINT, salad_bar SMALLINT, prepared_food SMALLINT, florist SMALLINT);
...
CREATE TABLE sales_fact_1997 (product_id INTEGER NOT NULL, time_id INTEGER NOT NULL, customer_id INTEGER NOT NULL, promotion_id INTEGER NOT NULL, store_id INTEGER NOT NULL, store_sales DECIMAL(10,4) NOT NULL, store_cost DECIMAL(10,4) NOT NULL, unit_sales DECIMAL(10,4) NOT NULL);

CREATE TABLE sales_fact_1998 (product_id INTEGER NOT NULL, time_id INTEGER NOT NULL, customer_id INTEGER NOT NULL, promotion_id INTEGER NOT NULL, store_id INTEGER NOT NULL, store_sales DECIMAL(10,4) NOT NULL, store_cost DECIMAL(10,4) NOT NULL, unit_sales DECIMAL(10,4) NOT NULL);
...
CREATE TABLE product (product_class_id INTEGER NOT NULL, product_id INTEGER NOT NULL, brand_name VARCHAR(60), product_name VARCHAR(60) NOT NULL, SKU BIGINT NOT NULL, SRP DECIMAL(10,4), gross_weight REAL, net_weight REAL, recyclable_package SMALLINT, low_fat SMALLINT, units_per_case SMALLINT, cases_per_pallet SMALLINT, shelf_width REAL, shelf_height REAL, shelf_depth REAL);

CREATE TABLE sales_fact_dec_1998 (product_id INTEGER NOT NULL, time_id INTEGER NOT NULL, customer_id INTEGER NOT NULL, promotion_id INTEGER NOT NULL, store_id INTEGER NOT NULL, store_sales DECIMAL(10,4) NOT NULL, store_cost DECIMAL(10,4) NOT NULL, unit_sales DECIMAL(10,4) NOT NULL);
...
CREATE TABLE promotion (promotion_id INTEGER NOT NULL, promotion_district_id INTEGER, promotion_name VARCHAR(30), media_type VARCHAR(30), cost DECIMAL(10,4), start_date TIMESTAMP, end_date TIMESTAMP);


ALTER TABLE store
modify first_opened_date datetime;

ALTER TABLE store
modify last_remodel_date datetime;

alter table reserve_employee
modify birth_date datetime;

alter table store_ragged
modify first_opened_date datetime;
